...
export default function CardCareer(props: any) {
  ...
  return (
    <button onClick={props.onClick} className={`${isActive === title ? ' lg:w-80 lg:h-160 w-60 h-155' : ' lg:w-55 lg:h-80 lg:hover:w-60 lg:hover:-ml-2 lg:hover:-mt-2 lg:hover:h-85 lg:transition-all lg:duration-200 w-55 h-70 hover:w-60 hover:-ml-2 hover:-mt-2 hover:h-85 transition-all duration-200'} lg:relative lg:border-1 lg:border-[#007924] lg:bg-white lg:rounded-xl lg:p-3 lg:flex lg:flex-col lg:justify-start lg:items-start lg:gap-4 relative border-1 border-[#007924] bg-white rounded-xl p-2 flex flex-col justify-start items-start gap-4`}>
        ...
        <div className={` lg:absolute lg:bottom-3 lg:w-58 lg:flex lg:flex-row lg:justify-start lg:items-center absolute bottom-2 w-58 flex ${isActive === title ? 'flex-row' : 'flex-col'} justify-start items-start`}>
            <button onClick={props.onClick} className={`${isActive === title ? 'lg:p-6 p-4' : 'lg:p-19 p-11'}  lg:py-2 lg:text-[#007924] lg:mr-2 lg:font-semibold lg:rounded-md lg:border-1 lg:border-[#007924] lg:text-sm lg:hover:bg-[#c8f0ff] lg:transition py-2 text-[#007924] mr-2 font-semibold rounded-md border-1 border-[#007924] text-[12px] hover:bg-[#c8f0ff] transition`}>
            Detail
            </button>
            {isActive === title &&
                <button className={`${isActive === title ? 'lg:p-19 p-11' : 'lg:p-7 p-11'} lg:py-2 lg:bg-[#007924] lg:text-white lg:font-semibold lg:rounded-md lg:text-sm lg:hover:bg-[#223d43] lg:transition py-2 bg-[#007924] text-white font-semibold rounded-md text-[12px] hover:bg-[#223d43] transition`}>
                Apply
                </button>
            }
        </div>
