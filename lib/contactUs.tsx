      ...
      <div className=" lg:flex lg:justify-center lg:w-250 lg:items-center lg:px-5 lg:py-5 flex flex-col justify-center items-center px-5 py-5 w-full">
        <div className=" lg:flex lg:flex-col lg:md:flex-row lg:w-full lg:max-w-6xl lg:bg-white lg:border-[1px] lg:border-[#97BED7] lg:rounded-3xl lg:shadow-xl lg:p-6 lg:gap-10 flex flex-col justify-center items-center md:flex-row w-full max-w-6xl bg-white border-[1px] border-[#97BED7] rounded-xl shadow-xl p-6 gap-10">
          <div className=" lg:w-full lg:md:w-2/3 lg:flex lg:flex-col lg:gap-4 w-full md:w-2/3 flex flex-col justify-center items-center gap-4">
            ...
            <textarea
              // onClick={() => setShowPopup(true)}
              className=" lg:bg-[#D9DFFC] lg:rounded-3xl lg:text-sm lg:px-5 lg:py-4 lg:text-[#181F38] lg:h-40 lg:w-full lg:resize-none bg-[#D9DFFC] rounded-lg text-[12px] px-5 py-4 text-[#181F38] h-40 w-full resize-none"
              placeholder="Message"
              id="message"
              name="message"
          ...
          <div className=" lg:w-full mt-3 lg:md:w-1/3 lg:flex lg:flex-col lg:gap-4 lg:text-[#4F006C] w-full md:w-1/3 flex flex-col justify-center items-center gap-4 text-[#4F006C]">
            
            <div className=" lg:bg-[#D9DFFC] lg:flex lg:flex-row lg:items-center lg:p-2 lg:pl-7 lg:rounded-2xl bg-[#D9DFFC] flex flex-row items-center p-4 pl-7 rounded-xl w-full">
              <Image width={140} height={140} src="/icon-jam.svg" alt="" className=' lg:w-5 lg:mr-4 w-6 mr-5'/>
              <div>
            ...
            <div className=" lg:bg-[#D9DFFC] lg:flex lg:flex-row lg:items-center lg:p-3 lg:pl-7 lg:rounded-2xl bg-[#D9DFFC] flex flex-row items-center p-4 pl-7 rounded-xl w-full">
              <Image width={140} height={140} src="/icon-phone.svg" alt="" className=' lg:w-4 lg:mr-4 w-6 mr-5'/>
              <div>
            ...
            <div className=" lg:bg-[#D9DFFC] lg:flex lg:flex-row lg:items-center lg:p-3 lg:pl-7 lg:rounded-2xl bg-[#D9DFFC] flex flex-row items-center p-3 pl-7 rounded-xl w-full">
              <Image width={140} height={140} src="/icon-email.svg" alt="" className=' lg:w-4 lg:mr-4 w-4 mr-4'/>
              <div>
                <p className="lg:text-sm text-[12px] text-[#181F38]">info@indokoding.com</p>
              </div>
            </div>

            <div className='text-[10px] text-[#181F38]'>
            ...
            <div className="lg:mt-1 mt-1 flex flex-col justify-center items-center">
              <p className=" lg:mb-2 lg:text-extrabold mb-2 text-extrabold text-[#181F38] text-[12px] font-bold">Follow our social media</p>
              <div className=" lg:flex lg:gap-4 flex gap-4">
                <div className=" lg:bg-[#D9DFFC] cursor-pointer lg:w-10 lg:h-10 lg:rounded-full lg:flex lg:items-center lg:justify-center bg-[#D9DFFC] w-10 h-10 rounded-full flex items-center justify-center">
                  <a href=" https://www.instagram.com/indokoding/" target="_blank" rel="noopener noreferrer">
                  <Image width={140} height={140} src="/fb-black.svg" alt="" className=' lg:w-3 w-3'/>
                  </a>
                </div>
                <div className=" lg:bg-[#D9DFFC] cursor-pointer lg:w-10 lg:h-10 lg:rounded-full lg:flex lg:items-center lg:justify-center bg-[#D9DFFC] w-10 h-10 rounded-full flex items-center justify-center">
                  <a href="http://www.instagram.com/indokoding/" target="_blank" rel="noopener noreferrer">
