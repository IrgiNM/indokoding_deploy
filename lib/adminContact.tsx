...
export default function Admincontacts() {
  ...
  const sortContacts = (data: Contact[], order: string) => {
    ...
    switch (order) {
      case "A - Z":
        return sortedData.sort((a, b) => a.subject.localeCompare(b.subject));

      case "Z - A":
        return sortedData.sort((a, b) => b.subject.localeCompare(a.subject));
      ...
      <div className="w-full h-1000 pl-50 flex flex-col bg-[#eff3ff]">
            ...
            >
              ...
              >
                <div className="flex flex-col items-start">
                  ...
                  >
                    {truncateTextByChar(contact.subject, 60)}{" "}
        ...
        {hapusMessage !== "none" && (
          <div className="fixed z-6 top-40 left-140 p-5 border-1 rounded-lg border-[#930062] bg-white flex flex-col gap-3 justify-center items-center">
            ...
            <button
              onClick={() => handleDelete(hapusMessage, pickEmail)}
              className="p-2 w-full rounded-md bg-[#e49fff] hover:bg-[#b700ff] active:bg-[#930062] text-[12px] text-[#9400cf] hover:text-white font-bold"
            >
              Yes
            </button>
        ...
        {detail && (
          <div className="fixed w-150 z-6 top-20 left-90 p-7 border-1 rounded-lg border-[#930062] bg-white flex flex-col justify-center items-start">
            ...
            <div className="flex flex-row gap-2 mb-7 items-center">
              <div className="w-10 h-10 bg-blue-100 flex justify-center items-center rounded-full font-bold text-md text-blue-700">
                {pickNama.charAt(0)}
              </div>
            ...
            <p className="max-h-50 pr-5 overflow-auto text-[12px] text-justify">
              {pickIsi}
            </p>
            <button
              onClick={() => klikDetail()}
