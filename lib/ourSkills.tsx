...
export default function OurSkills() {
  ...
  return (
    <div className='flex flex-col justify-center items-center relative mt-35 w-full'>
        ...
        <Image src="/assets/image/postgre.png" alt="gambar-postgre" className='w-55 absolute -top-10 -rotate-20 -right-10 z-2 scale-x-[-1]'/>
        <Image src="/assets/image/pythonb.png" alt="gambar-postgre" className='w-40 absolute -bottom-12 rotate-20 -left-10 z-2'/>
        {/* NORMAL */}
