...
export default function JoinUsPage() {
  ...
  useEffect(() => {
      ...
      const handleChangeJoinUsMessage = (e: React.ChangeEvent<HTMLInputElement>) => {
      ...
      const handleJoinUsMessage = async () => {
          if (!formDataJoinUsMessage.name || !formDataJoinUsMessage.email || 
            !formDataJoinUsMessage.from || !formDataJoinUsMessage.phone ||
            !formDataJoinUsMessage.rate || !formDataJoinUsMessage.position) {
      ...
      <div className='relative top-0'>
        ...
        <p className='lg:text-4xl lg:font-bold lg:italic lg:text-[#2C507A] lg:px-10 lg:pt-2 lg:pb-3 lg:border-5 lg:ml-20 lg:rounded-full lg:border-[#498cff] lg:backdrop-blur lg:absolute lg:-left-40 lg:-top-13 lg:-rotate-4 text-2xl font-bold italic text-[#181F38] px-5 pt-1 pb-2 border-3 rounded-full border-[#498cff] backdrop-blur absolute left-5 z-3 -top-7 -rotate-4'>Join Us</p>
          <div className=" lg:flex lg:flex-row lg:space-x-2 lg:gap-3 flex flex-col space-x-2 gap-3">
            ...
            type="text" placeholder="Your Name" className=" lg:bg-[#d9ebfc] lg:text-sm lg:text-[#00296c] lg:px-6 lg:py-3 lg:rounded-[40px] lg:w-[420px] bg-[#d9ebfc] text-sm text-[#00296c] px-6 py-3 border border-[#8eb0e5] rounded-lg w-[240px]" />
            <input 
            name="rate"
            value={formDataJoinUsMessage.rate}
            onChange={handleChangeJoinUsMessage}
            type="number" placeholder="How much rate do you want?" className="appearance-none [&::-webkit-inner-spin-button]:appearance-none [&::-webkit-outer-spin-button]:appearance-none lg:bg-[#d9ebfc] lg:text-sm lg:text-[#00296c] lg:px-6 lg:py-3 lg:pl-12 lg:rounded-[40px] lg:w-[260px] bg-[#d9ebfc] text-sm text-[#00296c] px-6 py-3 pl-11  rounded-lg w-[240px] border border-[#8eb0e5]" />
          ...
          <div className=" lg:flex lg:flex-row lg:space-x-2 lg:gap-4 flex flex-col space-x-2 gap-4">
            <div className=" lg:flex lg:flex-col lg:space-y-2 lg:gap-2 flex flex-col space-y-2 gap-2">
              <div className=" lg:flex lg:flex-row lg:space-x-2 flex flex-col space-x-2">
                <div className='lg:w-[200px] w-60 mr-4 lg:h-[50px] border-1 border-[#00296c] h-[50px] rounded-lg bg-[#d9ebfc] pr-8'>
                  ...
                  className="font-semibold focus:outline-none focus:ring-0 lg:text-sm lg:text-[#00296c] lg:bg-[#d9ebfc] lg:px-6 pr-7 lg:py-3 lg:rounded-[10px] lg:w-[180px] lg:h-[48px] text-[12px] text-[#00296c] bg-[#d9ebfc] px-6 py-2 rounded-[10px] w-55 h-[48px]" id="">
                ...
                onChange={handleChangeJoinUsMessage}
                type="text" placeholder="Where are you come from?" className=" lg:text-sm lg:text-[#00296c] lg:bg-[#d9ebfc] lg:px-6 lg:py-3 lg:rounded-[10px] lg:w-[205px] lg:h-[50px] lg:mt-0 text-sm text-[#00296c] bg-[#d9ebfc] px-6 py-3 rounded-[10px] w-[240px] h-[50px] mt-3 border border-[#8eb0e5]" />
              </div>
              <div className=" lg:flex lg:flex-row lg:space-x-2 flex flex-col space-x-2">
                <input 
                name="email"
                ...
                onChange={handleChangeJoinUsMessage}
                type="email" placeholder="Your email" className=" lg:text-sm lg:text-[#00296c] lg:bg-[#d9ebfc] lg:px-6 lg:py-3 lg: lg:rounded-[50px] lg:w-[205px] lg:h-[50px] text-sm text-[#00296c] bg-[#d9ebfc] px-6 py-3  rounded-lg w-[240px] h-[50px] border border-[#8eb0e5]" />
                <input 
                name="phone"
                value={formDataJoinUsMessage.phone}
                onChange={handleChangeJoinUsMessage}
                type="number" placeholder="Your phone number" className=" lg:text-sm lg:text-[#00296c] lg:bg-[#d9ebfc] lg:px-6 lg:py-3 lg:mt-0 lg:rounded-[50px] lg:w-[205px] lg:h-[50px] text-sm text-[#00296c] bg-[#d9ebfc] px-6 py-3 rounded-lg w-[240px] h-[50px] mt-3 border border-[#8eb0e5]" />
              </div>
            </div>
            <textarea
            name="message"
            ...
            onChange={(e) =>
             ...
             placeholder="Some more words, maybe?" className=" lg:bg-[#d9ebfc] lg:text-sm lg:text-[#00296c] lg:px-6 lg:py-3 lg: lg:rounded-[10px] lg:w-[260px] lg:h-[119px] bg-[#d9ebfc] text-sm text-[#00296c] px-6 py-3  rounded-[10px] w-[240px] h-[119px] border focus:border-[#498cff]" />
            </div>
          <button onClick={() => (handleJoinUsMessage())} className="cursor-pointer lg:mt-3 lg:w-[705px] lg:py-3 lg:bg-[#181F38] lg:text-sm lg:font-bold lg:text-white lg:rounded-full mt-3 w-[240px] py-3 bg-[#181F38] text-sm font-bold text-white rounded-full">
    ...
    {showAuthYet && (token === null || token === '') ?
            <>
                ...
                <div className='fixed z-9 lg:top-40 lg:left-140 top-50 left-27 p-5 border-1 rounded-lg border-purple-900 bg-white flex flex-col gap-3 justify-center items-center'>
                    ...
                    <button onClick={() => (setShowAuthYet(false))} className={`fixed z-6 lg:top-37 lg:right-133 lg:mr-0 -mr-40 top-46 w-8 h-8 rounded-full bg-[#AD48FF] flex justify-center items-center hover:bg-gradient-to-b hover:from-[#AD48FF] hover:to-[#6f09c3]`}>
            ...
            {showAuth && (token === null || token === '') ?
              <button onClick={()=>(setShowAuth(false))} className={`fixed z-13 lg:top-27 lg:right-105 top-36 right-7 w-8 h-8 rounded-full bg-[#AD48FF] flex justify-center items-center hover:bg-gradient-to-b hover:from-[#AD48FF] hover:to-[#6f09c3]`}>
                  <Image width={140} height={140} src="/close.svg" alt="" className="w-3"/>
              </button>
            : null
            }
