        ...
        <div className='w-full h-1000 pl-50 flex flex-col bg-[#eff3ff]'>
            ...
            <div className='fixed z-4 w-266 top-8 p-3 pl-5 border-t-[1px] border-[#f6d7ff] bg-white flex flex-row  justify-between gap-4'>
                ...
                <div className='relative flex flex-row gap-2'>
                    ...
                    { urutanActive && 
                        <div className='absolute z-7 w-30 h-50 border-[1.5px] rounded-lg border-[#cb48f3] top-10 right-82 backdrop-blur-md flex flex-col justify-center items-center gap-2 px-4'>
            ...
            {/* CAREER CONTROL */}
            <div className='fixed z-4 top-23 w-full pr-55 flex flex-row gap-2 justify-between items-center p-3 backdrop-blur-lg border-b-1 border-[#cb48f3]'>
            ...
            {detailRequest &&
                <div className='fixed w-full z-6 top-20 left-0 p-7 flex flex-row justify-center items-start'>
                    ...
                    <button onClick={()=>{setDetailRequest(!detailRequest)}} className={`fixed z-6 top-23 right-55 w-8 h-8 rounded-full bg-[#AD48FF] flex justify-center items-center hover:bg-gradient-to-b hover:from-[#AD48FF] hover:to-[#6f09c3] border-1 border-[#6f09c3]`}>
                        <Image width={140} height={140} src="/close.svg" alt="" className="w-3"/>
                    </button>
                    <button onClick={()=>{setDetailRequest(!detailRequest)}} className={`fixed z-6 top-32 right-55 w-8 h-8 rounded-full bg-[#ffc56f] flex justify-center items-center hover:bg-gradient-to-b hover:from-[#ffc56f] hover:to-[#ff7a32] border-1 border-[#c34a09]`}>
            ...
            {request &&
                <div className='fixed w-full z-6 top-20 left-0 p-7 flex flex-row justify-center items-start'>
                    <div className='w-200 bg-white p-7 rounded-lg border-1 border-[#930062] flex flex-col gap-3'>
                        <input type="text" placeholder='description' className='w-full text-[12px] pl-4 p-2 rounded-md border border-purple-900' />
                        <input type="text" placeholder='description' className='w-full text-[12px] pl-4 p-2 rounded-md border border-purple-900' />
                    </div>
                    <button onClick={()=>{setRequest(!request)}} className={`fixed z-6 top-23 right-55 w-8 h-8 rounded-full bg-[#AD48FF] flex justify-center items-center hover:bg-gradient-to-b hover:from-[#AD48FF] hover:to-[#6f09c3] border-1 border-[#6f09c3]`}>
                        <Image width={140} height={140} src="/close.svg" alt="" className="w-3"/>
                    </button>
                </div>
            }
